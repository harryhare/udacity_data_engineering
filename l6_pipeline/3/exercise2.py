...
def younger_riders(*args, ** kwargs):
...
def lifetime_rides(*args, ** kwargs):
    redshift_hook = PostgresHook("redshift")
...
def city_station_counts(*args, ** kwargs):
    redshift_hook = PostgresHook("redshift")
...
younger_riders = PythonOperator(
    task_id='younger_riders',
    dag=dag,
    python_callable=younger_riders,
    provide_context=True,
)
lifetime_rides = PythonOperator(
    task_id='lifetime_rides',
    dag=dag,
    python_callable=lifetime_rides,
    provide_context=True,
)


city_station_counts = PythonOperator(
    task_id='city_station_counts',
    dag=dag,
    python_callable=city_station_counts,
    provide_context=True,
)
